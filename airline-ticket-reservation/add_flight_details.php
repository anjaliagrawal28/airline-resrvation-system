	...
	<body>
		...
		<form action="add_flight_details_form_handler.php" method="post">
			...
			<table cellpadding="5">
				...
				<tr>
					<td class="fix_table">
					<input list="destinations" name="origin" placeholder="From" autocomplete="off" required>
  						<datalist id="destinations">
						  <option value="Ahemdabad(ADI)">
					...
					<td class="fix_table">
					<input list="destinations" name="destination" placeholder="To" autocomplete="off" required>
  						<datalist id="destinations">
						  <option value="Ahemdabad(ADI)">
							<option value="Amritsar(ASR)">
							<option value="Bangalore(BLR)">
